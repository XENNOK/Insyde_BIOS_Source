  ...
  )
{
  ...
  EFI_MEMORY_DESCRIPTOR         *EfiMemoryMapStart;
  UINTN                         Pages;
  VOID                          *BottomAddr;
  ...
  EfiMemoryMap = NULL;
  EfiEntry = NULL;
  EfiMemoryMapEnd = NULL;
  EfiMemoryMapStart = NULL;
  BottomAddr = NULL;
  ...
  EfiMemoryMapStart = EfiMemoryMap;
  EfiMemoryMapEnd = (EFI_MEMORY_DESCRIPTOR *) ((UINT8 *) EfiMemoryMap + EfiMemoryMapSize);
  EfiEntry = (EFI_MEMORY_DESCRIPTOR *) ((UINT8 *) EfiMemoryMapEnd - EfiDescriptorSize);

  while (EfiEntry >= EfiMemoryMapStart) {
    ...
    EfiEntry = (EFI_MEMORY_DESCRIPTOR *) ((UINT8 *) EfiEntry - EfiDescriptorSize);
  }
