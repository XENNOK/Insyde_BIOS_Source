  ...
  )
{
  ...
  case 0:
    mDxeHeciContext->HpetTimer = (VOID *) (UINTN) (SPS_HPET_ADDRESS_0);
    break;

  case 1:
    mDxeHeciContext->HpetTimer = (VOID *) (UINTN) (SPS_HPET_ADDRESS_1);
    break;

  case 2:
    mDxeHeciContext->HpetTimer = (VOID *) (UINTN) (SPS_HPET_ADDRESS_2);
    break;

  case 3:
    mDxeHeciContext->HpetTimer = (VOID *) (UINTN) (SPS_HPET_ADDRESS_3);
    break;

  default:
    mDxeHeciContext->HpetTimer = NULL;
    break;
  }
  ///
  ...
  *HpetConfigReg = *HpetConfigReg | B_SPS_RCRB_HPTC_AE;
  ...
  ///
  mDxeHeciContext->HpetTimer[SPS_HPET_GEN_CONFIG_LOW]  = SPS_HPET_START;
  mDxeHeciContext->HpetTimer[SPS_HPET_GEN_CONFIG_LOW]  = SPS_HPET_START;
  ...
  )
{
  ...
  ///
  *Start = mDxeHeciContext->HpetTimer[SPS_HPET_MAIN_COUNTER_LOW];
  ...
  )
{
  ...
  ///
  Current = mDxeHeciContext->HpetTimer[SPS_HPET_MAIN_COUNTER_LOW];
