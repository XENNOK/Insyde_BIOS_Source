...
#define SECURE_BOOT_MODE                        1
#define NORMAL_BOOT_MODE                        0
///
/// Globally "SecureBoot" variable to specify whether the system is currently booting
/// in secure boot mode (1) or not (0). All other values are reserved.
///
