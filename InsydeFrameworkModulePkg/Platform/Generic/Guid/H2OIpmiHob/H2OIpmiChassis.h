...
Abstract:
  ...
  Header file that contains IPMI Chassis Device Commands, data structures and
  definitions
...
#define H2O_IPMI_BOOT_OPTION_ENABLE   1
#define H2O_IPMI_BOOT_OPTION_DISABLE  0
#define H2O_IPMI_POWER_CYCLE_TIME     10
