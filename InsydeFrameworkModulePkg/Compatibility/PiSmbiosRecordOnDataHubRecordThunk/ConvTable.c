...
SMBIOS_TYPE_INFO_TABLE_ENTRY  mTypeInfoTable[] = {
  ...
  //
  // Type 41: Onboard Devices Extended Infomation
  //
  {
    41,
    0xD,
  ...
  //
  // Type 136 ( Type 0x88 ) : Compatible Revision ID ( CRID )
  //
  {
    0x88,
    0x8,
...
SMBIOS_CONVERSION_TABLE_ENTRY mConversionTable[] = {
  ...
  {
    //
    // Memory SubClass -- Record Type 2: Physical Memory Array (SMBIOS Type 16)
    //
  ...
  {
    //
    // Memory SubClass -- Record Type 8: Memory Controller information (SMBIOS Type 5)
    //
    EFI_MEMORY_SUBCLASS_GUID,
...
*/
  ...
  {
    //
    // Misc SubClass -- Record Type 0x22: Additional Information (SMBIOS Type 40)
    //
    EFI_MISC_SUBCLASS_GUID,
    0x22,//EFI_MISC_ADDITIONAL_INFORMATION_RECORD_NUMBER, // 22,
    40,
    BySubclassInstanceSubinstanceProducer,//BY_SUBCLASS_INSTANCE_SUBINSTANCE_PRODUCER,
  ...
  {
    //
    // Misc SubClass -- Record Type 0x23: Onboard Devices Extended Infomation (SMBIOS Type 41)
    //
    EFI_MISC_SUBCLASS_GUID,
    0x23,//EFI_MISC_ONBOARD_DEVICES_EXTENDED_INFORMATION_RECORD_NUMBER, // 23,
    41,
    BySubclassInstanceSubinstanceProducer,//BY_SUBCLASS_INSTANCE_SUBINSTANCE_PRODUCER,
    ByFunction,//BY_FUNCTION,
    0,
  ...
  {
    //
    // Misc SubClass -- Record Type 2F : Compatible Revision ID ( CRID ) ( SMBIOS Type 136 ( Type 0x88 ) )
    //
    EFI_MISC_SUBCLASS_GUID,
    0x2F,//EFI_MISC_COMPATIBLE_REVISION_ID_RECORD_NUMBER,
    0x88,
    BySubclassInstanceSubinstanceProducer,//BY_SUBCLASS_INSTANCE_SUBINSTANCE_PRODUCER,
    ByFunction,//BY_FUNCTION,
    0,
