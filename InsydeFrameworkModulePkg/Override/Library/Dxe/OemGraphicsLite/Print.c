...
/**
 ...
 @param [in]   GraphicsOutput   Graphics output protocol interface
 @param [in]   UgaDraw          UGA draw protocol interface
 @param [in]   Sto              Simple text out protocol interface
 @param [in]   X                X coordinate to start printing
 @param [in]   Y                Y coordinate to start printing
...
/**
 ...
 @param [out]  Buffer           Wide char buffer to print the results of the parsing of Format into.
 ...
 @param        ...              Vararg list consumed by processing Format.
...
/**
 ...
 @param [out]  StartOfBuffer    Unicode buffer to print the results of the parsing of Format into.
