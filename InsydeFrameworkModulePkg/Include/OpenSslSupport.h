...
#include "Tiano.h"
#include <openssl/InternalMiscLib.h>
...
//
#define memcpy(dest,source,count)         CryptLibCopyMem(dest,source,(UINTN)(count))
#define memset(dest,ch,count)             CryptLibSetMem(dest,(UINTN)(count),(UINT8)(ch))
#define memchr(buf,ch,count)              CryptLibScanMem8(buf,(UINTN)(count),(UINT8)ch)
#define memcmp(buf1,buf2,count)           (int)(CryptLibCompareMem(buf1,buf2,(UINTN)(count)))
#define memmove(dest,source,count)        CryptLibCopyMem(dest,source,(UINTN)(count))
#define strcmp                            CryptLibAsciiStrCmp
#define strncmp(string1,string2,count)    (int)(CryptLibAsciiStrnCmp(string1,string2,(UINTN)(count)))
#define strcpy(strDest,strSource)         CryptLibAsciiStrCpy(strDest,strSource)
#define strncpy(strDest,strSource,count)  CryptLibAsciiStrnCpy(strDest,strSource,(UINTN)count)
#define strlen(str)                       (size_t)(CryptLibAsciiStrLen(str))
#define strcat(strDest,strSource)         CryptLibAsciiStrCat(strDest,strSource)
#define strchr(str,ch)                    CryptLibScanMem8((VOID *)(str),CryptLibAsciiStrSize(str),(UINT8)ch)
