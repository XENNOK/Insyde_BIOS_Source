...
#include EFI_GUID_DEFINITION (InsydeModuleHii)

#define IFR_LIB_DEFAULT_STRING_SIZE     0x200


#define EFI_IFR_FLAGS_SUPPORT_TEXT_TWO       0x40
//
...
#define ACTION_QUESTION_FLAGS       (EFI_IFR_FLAGS_SUPPORT_TEXT_TWO | EFI_IFR_FLAG_READ_ONLY | EFI_IFR_FLAG_CALLBACK | EFI_IFR_FLAG_RESET_REQUIRED | EFI_IFR_FLAG_OPTIONS_ONLY)
#define ACTION_QUESTION_FLAGS_MASK  (~ACTION_QUESTION_FLAGS )
