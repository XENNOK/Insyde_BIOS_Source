...
//; Abstract:
//; 
//;   Chipset Lib Interface for Seamless SATA.
//; 

#ifndef _CHIPSET_LIB_INTERFACE_H_
#define _CHIPSET_LIB_INTERFACE_H_

#include "Tiano.h"
#include "ChipsetLib.h"

EFI_FORWARD_DECLARATION (EFI_CHIPSET_LIB_SERVICES_PROTOCOL);

#define EFI_CHIPSET_LIB_SERVICES_PROTOCOL_GUID \
   {0x7f98abb7, 0xcbe6, 0x4645, 0x91, 0x6, 0x8d, 0x70, 0xa1, 0x12, 0xc8, 0x1f}
...
typedef struct _EFI_CHIPSET_LIB_SERVICES_PROTOCOL {
...
extern EFI_GUID gEfiChipsetLibServicesProtocolGuid;
