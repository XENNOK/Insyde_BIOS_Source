/** @file
 H2O IPMI FRU header file.

 This files contains FRU related definitions and structures defined in IPMI and
 FRU specification.
...
//
#define H2O_IPMI_CMD_GET_FRU_INVENTORY_AREA_INFO   0x10
#define H2O_IPMI_CMD_READ_FRU_DATA                 0x11
#define H2O_IPMI_CMD_WRITE_FRU_DATA                0x12
#define H2O_IPMI_CMD_MAX_LENGTH                    0x10
